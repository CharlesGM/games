...
REM Check if pygame is installed in the virtual environment, install if not
python -c "import pygame" >nul 2>&1
if errorlevel 1 (
    echo 📥 Installing pygame in virtual environment...
    pip install pygame
    echo ✅ Pygame installed successfully!
) else (
    echo ✅ Pygame is already installed in virtual environment.
)
